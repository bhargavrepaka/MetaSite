...
/*=============== SERVICES MODEL ===============*/
const modelViews=document.querySelectorAll('.events__model')
const modelBtns=document.querySelectorAll('.events__button')
const modelClose=document.querySelectorAll('.events__model-close')
...
var mixer = mixitup('.events__container', {
    selectors: {
        target: '.events__card'
    },
    animation: {
